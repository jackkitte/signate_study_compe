...
dat["neighbourhood"] = dat["neighbourhood"].fillna(0)

cols = [
    "property_type", "cancellation_policy", "room_type", "number_of_reviews",
    "review_scores_rating", "neighbourhood", "y"
]
...
cols = [
    "property_type", "cancellation_policy", "room_type", "number_of_reviews",
    "review_scores_rating", "neighbourhood", "y", "t"
]
...
for train_index, test_index in kf.split(tr):
    ...
    model1 = learning_only(trainX, y_train)
